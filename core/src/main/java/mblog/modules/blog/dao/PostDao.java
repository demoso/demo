...
public interface PostDao extends JpaRepository<Post, Long>, JpaSpecificationExecutor<Post>, PostDaoCustom {
	 ...
	 * @param classnme
	 */
	Page<Post> findByAuthorIdAndMyclassifysLike(Pageable pageable, long authorId, String classnme);
	// findLatests
	...
	List<Post> findTop18ByAuthorIdAndIdNotInOrderByCreatedDesc(Long authorId, Collection<Long> id);

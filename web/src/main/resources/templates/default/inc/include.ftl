<meta property="Demoso:mblog" content="2.2.1">
${site_metas}
...
<link rel='stylesheet' media='all' href="${base}/theme/default/css/addons.css"/>
...
<!-- Favicons -->
<link rel="apple-touch-icon-precomposed" href="${base}/theme/default/images/favicon.png"/>
<link rel="shortcut icon" href="${base}/theme/default/images/favicon.png"/>

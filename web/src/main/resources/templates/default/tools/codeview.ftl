    ...
    <div class="row" style="background-color: #e5eecc;">
        <div class="panel panel-default" style="margin-bottom:0;">
            <div class="panel-body" style="background-color: #f9f9f9;border-color: #f9f9f9;">
                <form autocomplete="off" role="form" action="${base}/codesave/codeview/web" method="post"
                    ...
                    <div class="row">
                        <div class="col-sm-6" id="LeftPane">
                            <div class="row-fluid">
                                ...
                                <!--a  data-toggle="modal" data-target="#myModal" class="btn btn-success btn-xs pull-right inline" href="javascript:void(0);"  rel="follow">保存代码</a-->
                            </div>
